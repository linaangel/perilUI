                            ...
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Aircraft - Incident Information</h3>
                                    </div>
          ...
          ================================== -->
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Aircraft - Incident Detail</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
    			...
    			================================== -->
                                                <div class="col-md-4 form-group ">
                                                    <label>Was foam used on this operation?</label>
                                                    <br>
                                                ...
                                                <div class="col-md-8 form-group ">
                                                    <label>What type of foam was used?</label>
                                                    <div class="form-inline">
                                                        <input type="checkbox" name="stage" id="Incipient" value="male">
                                                        <label class="label-inner" for="Incipient">AFFF (Polar, Chem Guard)</label>
                                                        <input type="checkbox" name="stage" id="Growth" value="female">
                                                        <label class="label-inner" for="Growth">Purple K (Dry Chem)</label>
                                                        <input type="checkbox" name="stage" id="Fully" value="other">
                                                        <label class="label-inner" for="Fully">Extinguisher Metal X (Dry Chem)</label>
                                                        <br>
                                                        <input type="checkbox" name="stage" id="Smoldering" value="other">
                                                        <label class="label-inner" for="Smoldering">Extinguisher Purple X (Dry Chem)</label>
                                                        <input type="checkbox" name="stage" id="other2" value="other">
                                                        <label class="label-inner" for="other2">Extinguisher B/C (Dry Chem)</label>
                                                    </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Aircraft - Personal Protective Equipment</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
    			...
    			================================== -->
                                                <div class="col-md-6 col-sm-12 form-group ">
                                                    ...
                                                    <div class="form-inline">
                                                        ...
                                                        <input type="checkbox" name="ppe" id="Bunkerjac" value="male">
                                                        <label class="label-inner" for="Bunkerjac">Bunker jacket</label>
                                                        ...
                                                        <input type="checkbox" name="ppe" id="proximity" value="male">
                                                        <label class="label-inner" for="proximity">Proximity gear</label>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step4">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Aircraft - Decontamination</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Aircraft - Medical Symptoms</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">

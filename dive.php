            ...
            <div class="wizard">
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li id="step1li" role="presentation" class="active">
                            <a href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="Step 1">
                                <span class="round-tab">
                                <img src="img/scubagray.png" class="scuba">
                            </span>
                            </a>
                        </li>
                            ...
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Dive - Incident Information</h3>
                                    </div>
...
-->
          ...
          ================================== -->
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Dive - Incident Detail</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
    			...
    			================================== -->
                                                <div class="col-md-6 form-group ">
                                                    <label for="fire_type">What was the body of water type?</label>
                                                    <div class="form-inline">
                                                        <input type="radio" name="tabaccotype" id="Residential" value="male">
                                                        <label class="label-inner" for="Residential">Lake</label>
                                                        <input type="radio" name="tabaccotype" id="Vehicle" value="female">
                                                        <label class="label-inner" for="Vehicle">Canal</label>
                                                        <input type="radio" name="tabaccotype" id="Commercial" value="other">
                                                        <label class="label-inner" for="Commercial">Marsh/Wetlands</label>
                                                        <input type="radio" name="tabaccotype" id="Trash" value="other">
                                                        <label class="label-inner" for="Trash">Ocean</label>
                                                        <input type="radio" name="tabaccotype" id="Brush" value="other">
                                                        <label class="label-inner" for="Brush">Intracostal</label>
                                                ...
                                                <div class="col-md-6 form-group ">
                                                    <label>Was this body of water in an agricultural area?</label>
                                                    <br>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 form-group ">
                                                    <label>Did you enter the water?</label>
                                                    <br>
                                                    <input type="radio" name="contgear" id="nogearent" value="female">
                                                    <label class="label-inner" for="nogearent">No</label>
                                                    <input type="radio" name="contgear" id="yesgearent" value="other">
                                                    <label class="label-inner" for="yesgearent">Yes</label>
                                                    <button class="btn btn-primary next-step btn-lg btn-rsvp" type="button" id="reset" value="Clear" />Clear
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 form-group ">
                                                    <label>Were you ever completely submerged?</label>
                                                    <br>
                                                    <input type="radio" name="contgear" id="nogearsub" value="female">
                                                    <label class="label-inner" for="nogearsub">No</label>
                                                    <input type="radio" name="contgear" id="yesgearsub" value="other">
                                                    <label class="label-inner" for="yesgearsub">Yes</label>
                                                    <button class="btn btn-primary next-step btn-lg btn-rsvp" type="button" id="reset" value="Clear" />Clear
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 form-group ">
                                                    <label>Was there a submerged object in the water?</label>
                                                    <br>
                                                    <input type="radio" name="contgear" id="nogearwat" value="female">
                                                    <label class="label-inner" for="nogearwat">No</label>
                                                    <input type="radio" name="contgear" id="yesgearwat" value="other">
                                                    <label class="label-inner" for="yesgearwat">Yes</label>
                                                    <button class="btn btn-primary next-step btn-lg btn-rsvp" type="button" id="reset" value="Clear" />Clear
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 form-group ">
                                                    <label>Was there sheen on the surface of the water?</label>
                                                    <br>
                                                    <input type="radio" name="tabacco" id="nosuresurf" value="male">
                                                    <label class="label-inner" for="nosuresurf">Not Sure / Don't Know</label>
                                                    <input type="radio" name="tabacco" id="nosurf" value="female">
                                                    <label class="label-inner" for="nosurf">No</label>
                                                    <input type="radio" name="tabacco" id="yessurf" value="other">
                                                    <label class="label-inner" for="yessurf">Yes</label>
                                                    <button class="btn btn-primary next-step btn-lg btn-rsvp" type="button" id="reset3" value="Clear" />Clear
                                                </div>
                                            </div>
                                            <div class="row">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER#XXXXXX, Type: Dive - Personal Protective Equipment</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
    			...
    			================================== -->
                                                <div class="col-md-12 col-sm-12 form-group ">
                                                    ...
                                                    <div class="form-inline">
                                                        ...
                                                        <label class="label-inner" for="Bunker">Dry Suit</label>
                                                        <input type="checkbox" name="ppe" id="Boots" value="female">
                                                        <label class="label-inner" for="Boots">Wet Suit</label>
                                                        <input type="checkbox" name="ppe" id="Gloves" value="other">
                                                        <label class="label-inner" for="Gloves">Civilian Clothes</label>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step4">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Dive - Decontamination</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step5">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">PER #XXXXXX, Type: Dive - Medical Symptoms</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">

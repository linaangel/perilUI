            ...
            <div class="wizard">
                <div class="wizard-inner">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li id="#step1tab" role="presentation" class="active">
                        ...
                        <li id="#step2tab" role="presentation" class="disabled">
                        ...
                        <li id="#step3tab" role="presentation" class="disabled">
                        ...
                        <li id="#step4tab" role="presentation" class="disabled">
                        ...
                        <li id="#completetab" role="presentation" class="disabled">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div>
                                            <ul class="list-inline pull-right">
                                                <li>
                                                    <button type="button" class="btn btn-primary next-step btn-lg btn-rsvp"><i class="glyphicon glyphicon-log-in"></i> <a class="updatelink" href="#step2" data-toggle="tab" aria-controls="step2" role="tab" title="Step 2">Save and continue</a></button>
                                                </li>
                                            </ul>
                                        </div>
    			...
    			================================== -->
                                                <div class="col-md-6 form-group ">
                                                    ...
                                                    <div class="form-inline">
                                                        <input type="text" class="profile-race inputdynamic" id="race" name="races[]">
                                                    </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
                                                <li>
                                                    <button type="button" class="btn btn-default prev-step btn-lg btn-rsvp"><i class="glyphicon glyphicon-chevron-left"></i> <a class="updatelink" href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="Step 1">Previous</a></button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-default next-step btn-lg btn-rsvp"><a class="updatelink" href="#step3" data-toggle="tab" aria-controls="step3" role="tab" title="Step 3">Skip</a></button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-primary next-step btn-lg btn-rsvp"><i class="glyphicon glyphicon-log-in"></i> <a class="updatelink" href="#step3" data-toggle="tab" aria-controls="step3" role="tab" title="Step 3">Save and continue</a></button>
                                                </li>
                                            </ul>
                                        </div>
    			...
    			================================== -->
                                                ...
                                                <!-- CANCER TYPE
    			================================== -->
                                                <div id="typesSelectGroupDiv" class="col-md-6 form-group ">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
                                                <li>
                                                    <button type="button" class="btn btn-default prev-step btn-lg btn-rsvp"><i class="glyphicon glyphicon-chevron-left"></i> <a class="updatelink" href="#step2" data-toggle="tab" aria-controls="step2" role="tab" title="Step 2">Previous</a></button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-default next-step btn-lg btn-rsvp"><a class="updatelink" href="#step4" data-toggle="tab" aria-controls="complete" role="tab" title="Complete">Skip</a></button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-primary next-step btn-lg btn-rsvp"><i class="glyphicon glyphicon-log-in"></i> <a class="updatelink" href="#step4" data-toggle="tab" aria-controls="complete" role="tab" title="Complete">Save and continue</a></button>
                                                </li>
                                            </ul>
                                        </div>
    			...
    			================================== -->
                                                <div class="col-md-6 form-group ">
                                                    ...
                                                    <br>
                                                    <input type="radio" name="tabacco" id="no2" value="female">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <ul class="list-inline pull-right">
                                                <li>
                                                    <button type="button" class="btn btn-default prev-step btn-lg btn-rsvp"><i class="glyphicon glyphicon-chevron-left"></i> <a class="updatelink" href="#step3" data-toggle="tab" aria-controls="step3" role="tab" title="Step 3">Previous</a></button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-default next-step btn-lg btn-rsvp"><a class="updatelink" href="#complete" data-toggle="tab" aria-controls="complete" role="tab" title="Complete">Skip</a></button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn btn-primary next-step btn-lg btn-rsvp"><i class="glyphicon glyphicon-log-in"></i> <a class="updatelink" href="#complete" data-toggle="tab" aria-controls="complete" role="tab" title="Complete">Save and continue</a></button>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--                                        <br> * Required Fields-->
    			...
    			================================== -->
                                            ...
                                            <div class="form-inline">
                                                <label for="prefer"><strong>Preferred Contact Method:</strong></label>
                                                <br>
                                ...
                                <div class="row">
                                    <div class="panel panel-default">
                                        <div class="panel-heading container-fluid">
                                            ...
                                            <a class="updatelink" href="#step1" data-toggle="tab" aria-controls="step1" role="tab" title="Step 1">Update</a>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="panel panel-default">
                                        <div class="panel-heading container-fluid">
                                            ...
                                            <a class="updatelink" href="#step2" data-toggle="tab" aria-controls="step2" role="tab" title="Step 2">Update</a>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-6 fieldname">
                                ...
                                <div class="row">
                                    <div class="panel panel-default">
                                        <div class="panel-heading container-fluid">
                                            ...
                                            <a class="updatelink" href="#step3" data-toggle="tab" aria-controls="step3" role="tab" title="Step 3">Update</a>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-6 fieldname">
                                ...
                                <div class="row">
                                    <div class="panel panel-default">
                                        <div class="panel-heading container-fluid">
                                            ...
                                            <a class="updatelink" href="#step4" data-toggle="tab" aria-controls="complete" role="tab" title="Complete">Update</a>
                                        </div>
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-6 fieldname">
